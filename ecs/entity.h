...
/**
 * @brief Manages an array of entity handles
 */
template <int N = 256>
class EntityArray {
 public:
   ...
   * @return The signature bitmask of the entity.
   */
   ...
   * @param s The new signature bitmask to assign to the entity.
   */
   ...
   *
   * @param e The handle of the entity.
   * @param s The signature bitmask to combine with the .
   */
